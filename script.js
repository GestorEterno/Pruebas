...
// CARRUSEL DE SHORTS - COMPLETAMENTE REFACTORIZADO Y FUNCIONAL
class ShortsCarousel {
    constructor() {
        ...
        this.indicatorsContainer = document.querySelector('.shorts-indicators');
    ...
    updateItemsPerView() {
        ...
        // Reconfigurar indicadores si cambió el número de páginas
    ...
    updateCarousel() {
        ...
        const translateX = -(this.currentPage * (containerWidth + gap));
    ...
    updateButtons() {
        ...
        if (this.nextBtn) {
            const isDisabled = this.currentPage >= this.totalPages - 1;
...
// CARRUSEL DE CANALES - COMPLETAMENTE REFACTORIZADO Y FUNCIONAL
class ChannelsCarousel {
    constructor() {
        ...
        this.indicatorsContainer = document.querySelector('.channels .carousel-indicators');
